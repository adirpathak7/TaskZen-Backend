...
public class ContractEntity {
    ...
    public ContractEntity(int contract_id, ClientMasterEntity clientMasterEntity, CompanyMasterEntity companyMasterEntity, String start_date, String end_date, String amount_agreed, Status status, LocalDateTime created_at) {
