...
public class CompanyReviewEntity {
    ...
    public CompanyReviewEntity(int client_review_id, CompanyMasterEntity companyMasterEntity, ClientMasterEntity clientMasterEntity, String comment, int rating, LocalDateTime createdAt) {
