...
public class SkillsEntity {
    ...
    public SkillsEntity(int skill_id, ClientMasterEntity clientMasterEntity, CompanyMasterEntity companyMasterEntity, String skill_name, LocalDateTime created_at) {
